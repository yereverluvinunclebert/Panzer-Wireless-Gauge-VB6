...
Begin VB.Form panzerPrefs 
   ...
   Begin VB.Frame fraGeneral 
      ...
      Begin VB.Frame fraGeneralInner 
         ...
         Top             =   300
         Width           =   6750
         Begin VB.ComboBox cmbCurrentWireless 
            Height          =   315
   ...
   Begin VB.Frame fraDevelopment 
      ...
      Begin VB.Frame fraDevelopmentInner 
         ...
         Begin VB.ComboBox cmbDebug 
            Height          =   315
            ItemData        =   "frmPrefs.frx":16D9
            Left            =   1530
            List            =   "frmPrefs.frx":16DB
            Style           =   2  'Dropdown List
            TabIndex        =   54
   ...
   Begin VB.Menu prefsMnuPopmenu 
      ...
      Begin VB.Menu mnuAbout 
         Caption         =   "About Panzer OHM Widget"
      End
      Begin VB.Menu blank 
         Caption         =   "-"
      End
...
' ----------------------------------------------------------------
' Procedure Name: cmbCurrentWireless_Click
' Purpose:
' Procedure Kind: Sub
...
' Date: 13/01/2024
' ----------------------------------------------------------------
Private Sub cmbCurrentWireless_Click()
    On Error GoTo cmbCurrentWireless_Click_Error
    
    btnSave.Enabled = True ' enable the save button
    PzGPercentWireless = cmbCurrentWireless.ListIndex
    sPutINISetting "Software\PzWirelessGauge", "percentWireless", PzGPercentWireless, PzGSettingsFile
    
    overlayWidget.thisWirelessNo = cmbCurrentWireless.ListIndex
    
    On Error GoTo 0
    Exit Sub

cmbCurrentWireless_Click_Error:

    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure cmbCurrentWireless_Click, line " & Erl & "."
...
Private Sub chkDpiAwareness_Click()
    ...
    If prefsStartupFlg = False Then ' don't run this on startup
        ...
        sPutINISetting "Software\PzWirelessGauge", "dpiAwareness", PzGDpiAwareness, PzGSettingsFile
...
Private Sub chkEnablePrefsTooltips_Click()
   ...
   On Error GoTo chkEnablePrefsTooltips_Click_Error
    ...
    If prefsStartupFlg = False Then
        ...
        sPutINISetting "Software\PzWirelessGauge", "enablePrefsTooltips", PzGEnablePrefsTooltips, PzGSettingsFile
...
'    End If
    ...
    If PzGStartup = "1" Then
        Call savestring(HKEY_CURRENT_USER, "SOFTWARE\Microsoft\Windows\CurrentVersion\Run", "PzWirelessGaugeWidget", """" & App.path & "\" & "Panzer Wireless Gauge.exe""")
    Else
        Call savestring(HKEY_CURRENT_USER, "SOFTWARE\Microsoft\Windows\CurrentVersion\Run", "PzWirelessGaugeWidget", vbNullString)
    End If

    ' save the values from the general tab
    If fFExists(PzGSettingsFile) Then
        sPutINISetting "Software\PzWirelessGauge", "enableTooltips", PzGEnableTooltips, PzGSettingsFile
        sPutINISetting "Software\PzWirelessGauge", "enablePrefsTooltips", PzGEnablePrefsTooltips, PzGSettingsFile
        sPutINISetting "Software\PzWirelessGauge", "enableBalloonTooltips", PzGEnableBalloonTooltips, PzGSettingsFile
        sPutINISetting "Software\PzWirelessGauge", "showTaskbar", PzGShowTaskbar, PzGSettingsFile
        sPutINISetting "Software\PzWirelessGauge", "dpiAwareness", PzGDpiAwareness, PzGSettingsFile
        
        
        sPutINISetting "Software\PzWirelessGauge", "gaugeSize", PzGGaugeSize, PzGSettingsFile
        ...
        'sPutINISetting "Software\PzWirelessGauge", "clockFaceSwitchPref", PzGClockFaceSwitchPref, PzGSettingsFile
        
        sPutINISetting "Software\PzWirelessGauge", "aspectHidden", PzGAspectHidden, PzGSettingsFile
        sPutINISetting "Software\PzWirelessGauge", "widgetPosition", PzGWidgetPosition, PzGSettingsFile
        sPutINISetting "Software\PzWirelessGauge", "widgetLandscape", PzGWidgetLandscape, PzGSettingsFile
        sPutINISetting "Software\PzWirelessGauge", "widgetPortrait", PzGWidgetPortrait, PzGSettingsFile

        sPutINISetting "Software\PzWirelessGauge", "prefsFont", PzGPrefsFont, PzGSettingsFile
        sPutINISetting "Software\PzWirelessGauge", "clockFont", PzGClockFont, PzGSettingsFile
        
        sPutINISetting "Software\PzWirelessGauge", "prefsFontSizeHighDPI", PzGPrefsFontSizeHighDPI, PzGSettingsFile
        sPutINISetting "Software\PzWirelessGauge", "prefsFontSizeLowDPI", PzGPrefsFontSizeLowDPI, PzGSettingsFile
        sPutINISetting "Software\PzWirelessGauge", "prefsFontItalics", PzGPrefsFontItalics, PzGSettingsFile
        sPutINISetting "Software\PzWirelessGauge", "prefsFontColour", PzGPrefsFontColour, PzGSettingsFile

        'save the values from the Windows Config Items
        sPutINISetting "Software\PzWirelessGauge", "windowLevel", PzGWindowLevel, PzGSettingsFile
        sPutINISetting "Software\PzWirelessGauge", "preventDragging", PzGPreventDragging, PzGSettingsFile
        
        sPutINISetting "Software\PzWirelessGauge", "opacity", PzGOpacity, PzGSettingsFile
        sPutINISetting "Software\PzWirelessGauge", "widgetHidden", PzGWidgetHidden, PzGSettingsFile
        sPutINISetting "Software\PzWirelessGauge", "hidingTime", PzGHidingTime, PzGSettingsFile
        sPutINISetting "Software\PzWirelessGauge", "ignoreMouse", PzGIgnoreMouse, PzGSettingsFile
        
        
        sPutINISetting "Software\PzWirelessGauge", "startup", PzGStartup, PzGSettingsFile

        sPutINISetting "Software\PzWirelessGauge", "enableSounds", PzGEnableSounds, PzGSettingsFile
        sPutINISetting "Software\PzWirelessGauge", "lastSelectedTab", PzGLastSelectedTab, PzGSettingsFile
        
        sPutINISetting "Software\PzWirelessGauge", "debug", PzGDebug, PzGSettingsFile
        sPutINISetting "Software\PzWirelessGauge", "dblClickCommand", PzGDblClickCommand, PzGSettingsFile
        sPutINISetting "Software\PzWirelessGauge", "openFile", PzGOpenFile, PzGSettingsFile
        sPutINISetting "Software\PzWirelessGauge", "defaultEditor", PzGDefaultEditor, PzGSettingsFile
        
        sPutINISetting "Software\PzWirelessGauge", "clockHighDpiXPos", PzGClockHighDpiXPos, PzGSettingsFile
        sPutINISetting "Software\PzWirelessGauge", "clockHighDpiYPos", PzGClockHighDpiYPos, PzGSettingsFile
        
        sPutINISetting "Software\PzWirelessGauge", "clockLowDpiXPos", PzGClockLowDpiXPos, PzGSettingsFile
        sPutINISetting "Software\PzWirelessGauge", "clockLowDpiYPos", PzGClockLowDpiYPos, PzGSettingsFile
...
Private Sub lblGitHub_dblClick()
    ...
    If answer = vbYes Then
       Call ShellExecute(Me.hwnd, "Open", "https://github.com/yereverluvinunclebert/Panzer-Wireless-Gauge-VB6", vbNullString, App.path, 1)
    End If
...
'        sliAnimationInterval.ToolTipText = "Adjust to make the animation smooth or choppy. Any adjustment in the interval takes place instantly. Lower values are smoother but the smoother it runs the more Wireless it uses."
...
'        cmbMainDaylightSaving.ToolTipText = "Select and activate Daylight Savings Time for your area."
        ...
        cmbTickSwitchPref.ToolTipText = "The movement of the hand can be set to smooth or regular flicks, the smooth movement uses slightly more Wireless."
...
'    panzerPrefs.sliAnimationInterval.BackColor = RGB(redC, greenC, blueC)
    ...
    sPutINISetting "Software\PzWirelessGauge", "skinTheme", PzGSkinTheme, PzGSettingsFile
