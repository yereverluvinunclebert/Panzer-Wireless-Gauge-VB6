...
Begin VB.Form widgetPrefs 
   Caption         =   "Panzer Wireless Gauge Preferences"
   ClientHeight    =   10545
   ClientLeft      =   60
   ClientTop       =   510
   ClientWidth     =   8880
...
Private Sub optGaugeTooltips_Click(Index As Integer)
    ...
    If pvtPrefsStartupFlg = False Then
        ...
        sPutINISetting "Software\PzWirelessGauge", "gaugeTooltips", gblGaugeTooltips, gblSettingsFile
...
Private Sub optPrefsTooltips_Click(Index As Integer)
   ...
   On Error GoTo optPrefsTooltips_Click_Error
    ...
    If pvtPrefsStartupFlg = False Then
        ...
        sPutINISetting "Software\PzWirelessGauge", "prefsTooltips", gblPrefsTooltips, gblSettingsFile
   ...
   On Error GoTo cmbMultiMonitorResize_Click_Error
    ...
    If cmbMultiMonitorResize.ListIndex = 2 Then
        If prefsMonitorStruct.IsPrimary = True Then
            ...
            sPutINISetting "Software\PzWirelessGauge", "gaugePrimaryHeightRatio", gblGaugePrimaryHeightRatio, gblSettingsFile
            
            'gblPrefsPrimaryHeightTwips = Trim$(cstr(widgetPrefs.Height))
            sPutINISetting "Software\PzWirelessGauge", "prefsPrimaryHeightTwips", gblPrefsPrimaryHeightTwips, gblSettingsFile
        Else
            gblGaugeSecondaryHeightRatio = fGauge.gaugeForm.WidgetRoot.Zoom
            sPutINISetting "Software\PzWirelessGauge", "gaugeSecondaryHeightRatio", gblGaugeSecondaryHeightRatio, gblSettingsFile
            
            'gblPrefsSecondaryHeightTwips = Trim$(cstr(widgetPrefs.Height))
            sPutINISetting "Software\PzWirelessGauge", "prefsSecondaryHeightTwips", gblPrefsSecondaryHeightTwips, gblSettingsFile
        End If
    End If
...
Private Sub Form_Load()
    ...
    Me.mnuAbout.Caption = "About Panzer Wireless Gauge Cairo " & gblCodingEnvironment & " widget"
...
Public Sub positionPrefsMonitor()
    ...
    If gblMonitorCount > 1 And LTrim$(gblMultiMonitorResize) = "2" Then
        ...
        If prefsMonitorStruct.IsPrimary = True Then
            gblPrefsFormResizedInCode = True
            gblPrefsPrimaryHeightTwips = fGetINISetting("Software\PzWirelessGauge", "prefsPrimaryHeightTwips", gblSettingsFile)
            ...
            End If
        Else
            gblPrefsSecondaryHeightTwips = fGetINISetting("Software\PzWirelessGauge", "prefsSecondaryHeightTwips", gblSettingsFile)
            gblPrefsFormResizedInCode = True
...
Private Sub chkDpiAwareness_Click()
    ...
    If pvtPrefsStartupFlg = False Then ' don't run this on startup
        ...
        sPutINISetting "Software\PzWirelessGauge", "dpiAwareness", gblDpiAwareness, gblSettingsFile
...
Private Sub cmbDebug_Click()
    ...
    If cmbDebug.ListIndex = 0 Then
        txtDefaultEditor.Text = "eg. E:\vb6\Panzer-Wireless-Gauge-VB6MkII\Panzer-Wireless-Gauge-VB6.vbp"
...
'    End If
    ...
    If gblStartup = "1" Then
        Call writeRegistry(HKEY_CURRENT_USER, "SOFTWARE\Microsoft\Windows\CurrentVersion\Run", "PanzerWirelessGauge", """" & App.Path & "\" & "Panzer-Wireless-Gauge-VB6.exe""")
    Else
        Call writeRegistry(HKEY_CURRENT_USER, "SOFTWARE\Microsoft\Windows\CurrentVersion\Run", "PanzerWireless Gauge", vbNullString)
    End If
    ...
    If fFExists(gblSettingsFile) Then
        ...
        sPutINISetting "Software\PzWirelessGauge", "showTaskbar", gblShowTaskbar, gblSettingsFile
        sPutINISetting "Software\PzWirelessGauge", "showHelp", gblShowHelp, gblSettingsFile
        
        sPutINISetting "Software\PzWirelessGauge", "dpiAwareness", gblDpiAwareness, gblSettingsFile
        
        
        sPutINISetting "Software\PzWirelessGauge", "gaugeSize", gblGaugeSize, gblSettingsFile
        sPutINISetting "Software\PzWirelessGauge", "scrollWheelDirection", gblScrollWheelDirection, gblSettingsFile
                
        sPutINISetting "Software\PzWirelessGauge", "widgetFunctions", gblGaugeFunctions, gblSettingsFile
        
        sPutINISetting "Software\PzWirelessGauge", "pointerAnimate", gblPointerAnimate, gblSettingsFile
        sPutINISetting "Software\PzWirelessGauge", "samplingInterval", gblSamplingInterval, gblSettingsFile
        
              
        sPutINISetting "Software\PzWirelessGauge", "aspectHidden", gblAspectHidden, gblSettingsFile
        sPutINISetting "Software\PzWirelessGauge", "widgetPosition", gblWidgetPosition, gblSettingsFile
        sPutINISetting "Software\PzWirelessGauge", "widgetLandscape", gblWidgetLandscape, gblSettingsFile
        sPutINISetting "Software\PzWirelessGauge", "widgetPortrait", gblWidgetPortrait, gblSettingsFile

        sPutINISetting "Software\PzWirelessGauge", "prefsFont", gblPrefsFont, gblSettingsFile
        sPutINISetting "Software\PzWirelessGauge", "gaugeFont", gblGaugeFont, gblSettingsFile
        
        sPutINISetting "Software\PzWirelessGauge", "prefsFontSizeHighDPI", gblPrefsFontSizeHighDPI, gblSettingsFile
        sPutINISetting "Software\PzWirelessGauge", "prefsFontSizeLowDPI", gblPrefsFontSizeLowDPI, gblSettingsFile
        sPutINISetting "Software\PzWirelessGauge", "prefsFontItalics", gblPrefsFontItalics, gblSettingsFile
        sPutINISetting "Software\PzWirelessGauge", "prefsFontColour", gblPrefsFontColour, gblSettingsFile
        
        sPutINISetting "Software\PzWirelessGauge", "displayScreenFont", gblDisplayScreenFont, gblSettingsFile
        sPutINISetting "Software\PzWirelessGauge", "displayScreenFontSize", gblDisplayScreenFontSize, gblSettingsFile
        sPutINISetting "Software\PzWirelessGauge", "displayScreenFontItalics", gblDisplayScreenFontItalics, gblSettingsFile
        sPutINISetting "Software\PzWirelessGauge", "displayScreenFontColour", gblDisplayScreenFontColour, gblSettingsFile

        'save the values from the Windows Config Items
        sPutINISetting "Software\PzWirelessGauge", "windowLevel", gblWindowLevel, gblSettingsFile
        sPutINISetting "Software\PzWirelessGauge", "preventDragging", gblPreventDragging, gblSettingsFile
        
        sPutINISetting "Software\PzWirelessGauge", "opacity", gblOpacity, gblSettingsFile
        sPutINISetting "Software\PzWirelessGauge", "widgetHidden", gblWidgetHidden, gblSettingsFile
        sPutINISetting "Software\PzWirelessGauge", "hidingTime", gblHidingTime, gblSettingsFile
        sPutINISetting "Software\PzWirelessGauge", "ignoreMouse", gblIgnoreMouse, gblSettingsFile
        sPutINISetting "Software\PzWirelessGauge", "multiMonitorResize", gblMultiMonitorResize, gblSettingsFile
        
        
        sPutINISetting "Software\PzWirelessGauge", "startup", gblStartup, gblSettingsFile

        sPutINISetting "Software\PzWirelessGauge", "enableSounds", gblEnableSounds, gblSettingsFile
'        sPutINISetting "Software\PzWirelessGauge", "enableTicks", gblEnableTicks, gblSettingsFile
'        sPutINISetting "Software\PzWirelessGauge", "enableChimes", gblEnableChimes, gblSettingsFile
'        sPutINISetting "Software\PzWirelessGauge", "enableAlarms", gblEnableAlarms, gblSettingsFile
'        sPutINISetting "Software\PzWirelessGauge", "volumeBoost", gblVolumeBoost, gblSettingsFile
        
        sPutINISetting "Software\PzWirelessGauge", "lastSelectedTab", gblLastSelectedTab, gblSettingsFile
        
        sPutINISetting "Software\PzWirelessGauge", "debug", gblDebug, gblSettingsFile
        sPutINISetting "Software\PzWirelessGauge", "dblClickCommand", gblDblClickCommand, gblSettingsFile
        sPutINISetting "Software\PzWirelessGauge", "openFile", gblOpenFile, gblSettingsFile
        sPutINISetting "Software\PzWirelessGauge", "defaultVB6Editor", gblDefaultVB6Editor, gblSettingsFile
        sPutINISetting "Software\PzWirelessGauge", "defaultTBEditor", gblDefaultTBEditor, gblSettingsFile
        
        sPutINISetting "Software\PzWirelessGauge", "gaugeHighDpiXPos", gblGaugeHighDpiXPos, gblSettingsFile
        sPutINISetting "Software\PzWirelessGauge", "gaugeHighDpiYPos", gblGaugeHighDpiYPos, gblSettingsFile
        
        sPutINISetting "Software\PzWirelessGauge", "gaugeLowDpiXPos", gblGaugeLowDpiXPos, gblSettingsFile
        sPutINISetting "Software\PzWirelessGauge", "gaugeLowDpiYPos", gblGaugeLowDpiYPos, gblSettingsFile
...
'    chkVolumeBoost.Value = Val(gblVolumeBoost)
    ...
    lblGitHub.Caption = "You can find the code for the Panzer Wireless Gauge on github, visit by double-clicking this link https://github.com/yereverluvinunclebert/Panzer-Wireless-Gauge"
...
Private Sub lblGitHub_dblClick()
    ...
    If answer = vbYes Then
        Call ShellExecute(Me.hWnd, "Open", "https://github.com/yereverluvinunclebert/Panzer-Wireless-Gauge-" & gblCodingEnvironment, vbNullString, App.Path, 1)
    End If
...
'    widgetPrefs.sliAnimationInterval.BackColor = RGB(redC, greenC, blueC)
    ...
    sPutINISetting "Software\PzWirelessGauge", "skinTheme", gblSkinTheme, gblSettingsFile
