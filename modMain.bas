...
Public Sub mainRoutine(ByVal restart As Boolean)
    ...
    Call readSettingsFile("Software\PzWirelessGauge", PzGSettingsFile)
...
Private Sub checkFirstTime()
   ...
   On Error GoTo checkFirstTime_Error
    ...
    If PzGFirstTimeRun = "true" Then
        ...
        sPutINISetting "Software\PzWirelessGauge", "firstTimeRun", PzGFirstTimeRun, PzGSettingsFile
    End If
...
'        PzGClockFaceSwitchPref = fGetINISetting(location, "clockFaceSwitchPref", PzGSettingsFile)
        ...
        ' other
        PzGClockHighDpiXPos = fGetINISetting("Software\PzWirelessGauge", "clockHighDpiXPos", PzGSettingsFile)
        PzGClockHighDpiYPos = fGetINISetting("Software\PzWirelessGauge", "clockHighDpiYPos", PzGSettingsFile)
        
        PzGClockLowDpiXPos = fGetINISetting("Software\PzWirelessGauge", "clockLowDpiXPos", PzGSettingsFile)
        PzGClockLowDpiYPos = fGetINISetting("Software\PzWirelessGauge", "clockLowDpiYPos", PzGSettingsFile)
...
Private Sub getToolSettingsFile()
    ...
    PzGSettingsDir = fSpecialFolder(feUserAppData) & "\PzWirelessGauge" ' just for this user alone
...
Private Sub handleUnhideMode(ByVal thisUnhideMode As String)
    ...
    If thisUnhideMode = "unhide" Then     'parse the command line
        PzGUnhide = "true"
        sPutINISetting "Software\PzWirelessGauge", "unhide", PzGUnhide, PzGSettingsFile
